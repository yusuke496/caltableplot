...
#Static1 = tkinter.Label(text='test1')
#Static1.pack()
#Static1.place(x=100, y=200)

#Static2 = tkinter.Label(text='test2')
#Static2.pack()
...
Static4 = tkinter.Label(text='Ch')
Static4.pack()
Static4.place(x=30, y=60)

Static5 = tkinter.Label(text='Gass # (0-4)')
Static5.pack()
Static5.place(x=30, y=80)

Static6 = tkinter.Label(text='Temp')
Static6.pack()
Static6.place(x=30, y=100)

Static7 = tkinter.Label(text='Press')
Static7.pack()
Static7.place(x=30, y=120)
